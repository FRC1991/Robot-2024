...
public class Utils {
  ...
  public static boolean checkMotor(CANSparkMax motor, int CANId) {
    ...
    //   System.out.println("CAN Id: " + CANId + "   Error code: Bad CAN ID");
    //   return false;
    // }

    // // Check motor temp.
    // // if(motor.getMotorTemperature() >= 40) {
    // //   System.out.println("CAN Id: " + CANId + "   Error code: Temperature check");
    // //   return false;
    // // }
    ...
    //   System.out.println("CAN Id: " + CANId + "   Error code: Motor Type");
    //   return false;
    // }
    ...
    // if(motor.get() != 0) {
    //   if(motor.getOutputCurrent() >= 120) {
    //     System.out.println("CAN Id: " + CANId + "   Error code: Output current  " + motor.getOutputCurrent());
    //     return false;
    //   }
    // }
    ...
    //   System.out.println("CAN Id: " + CANId + "   Error code: Bus Voltage");
    //   return false;
    // }
    ...
    //   System.out.println("CAN Id: " + CANId + "   Error code: General fault");
    //   return false;
    // }
